/**
 * Crop Recommendation Module (Pure JavaScript JSX)
 * Soil N-P-K & pH diagnostic sliders, suitability match score calculations, and Traditional Organic Farming Wisdom.
 */

import React, { useState } from 'react';
import { Sprout, Sparkles, CheckCircle2, BookOpen, Droplets, FlaskConical, Award } from 'lucide-react';
...
export const CropRecommendation = () => {
  const { selectedDistrict, showToast } = useApp();
  ...
  const [recommendations, setRecommendations] = useState(mockCropSuitabilityList);
  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Soil NPK Input Controls (Left 5 Cols) */}
        <Card className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between text-xs font-black text-black dark:text-white mb-1">
                ...
                <span className="text-emerald-800 dark:text-emerald-400">Slightly Acidic / Ideal</span>
              </div>
              <input
                type="range"
                min="4.5"
          ...
          >
            ...
            <span>{isAnalyzing ? 'Calculating Soil Agronomy...' : 'Generate Crop Suitability'}</span>
          </Button>
        </Card>

        {/* Suitability Results (Right 7 Cols) */}
        <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4">
              {recommendations.map(crop => (
                <div key={crop.cropName} className="p-4 rounded-2xl border border-[#C4C4BE] bg-[#FAF9F6] dark:bg-slate-900 space-y-3">
                  ...
                  <Progress value={crop.matchScore} color="emerald" height="h-2" />
          ...
          {/* Traditional Organic Farming Recipes Section */}
          <Card className="space-y-4">
            <div className="flex items-center justify-between border-b border-[#C4C4BE] dark:border-slate-800 pb-3">
              <h3 className="card-title text-base font-black text-black dark:text-white flex items-center gap-2">
